...
jQuery(document).ready(function() {
    ...
    if ( jQuery(".wbgm-gold-member-add-to-cart").length ) {
        ...
        jQuery(document).on("mouseenter", "li.shopping-bag-item", function () {
            ...
            jQuery("a.remove.remove-product").click(function () {
                ...
                jQuery(".wbgm-custom-notices-add.wbgm-shop span." + removedID).parent().remove();
                if (priceP == '0,00 €') {
                    isExistGift = true;
                ...
                if( isExistGift ) {
                    jQuery(".wbgm-custom-notices-remove.wbgm-shop span." + removedID).parent().remove();
    ...
    jQuery(".wbgm-gold-member-add-to-cart").click(function () {
        ...
        var parentLI = jQuery(this).parent().parent().parent();
        var label = jQuery(parentLI.children()[1])[0].innerHTML;
        var qty = 0;
